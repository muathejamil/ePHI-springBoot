...
public class PatientRepositoryImpl implements PatientRepository {
    ...
    private final MongoEntityInformation<Patient, String> entityInformation;

    public PatientRepositoryImpl(MongoOperations mongoOperations) {
        this.mongoOperations = mongoOperations;
        this.entityInformation = MongoHelper.getEntityInformationFor(Patient.class, String.class);
    }

    @Override
    public <S extends Patient> S save(S entity) {
        entity.setId(PATIENT_PREFIX + UUID.randomUUID());
    ...
    private List<Patient> findAll(@Nullable Query query) {
    ...
    public Patient update(Patient entity) {
        ...
        Optional<Patient> oldReport = findById(id);
