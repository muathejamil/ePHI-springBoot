...
public class ContactRepositoryImpl implements ContactRepository {
    ...
    private final MongoEntityInformation<Contact, String> entityInformation;

    public ContactRepositoryImpl(MongoOperations mongoOperations) {
        this.mongoOperations = mongoOperations;
        this.entityInformation = MongoHelper.getEntityInformationFor(Contact.class, String.class);
    }

    @Override
    public <S extends Contact> S save(S entity) {
        entity.setId(CONTACT_PREFIX + UUID.randomUUID());
    ...
    private List<Contact> findAll(@Nullable Query query) {
    ...
    public Contact update(Contact entity) {
        ...
        Optional<Contact> oldEntity = findById(id);
